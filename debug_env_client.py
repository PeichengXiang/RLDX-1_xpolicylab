...
from XPolicyLab.policy.RLDX_1.runtime_support import (
    get_robot_action_dim_info as _private_get_robot_action_dim_info,
)


def get_robot_action_dim_info(env_cfg_type):
    """Resolve private RLDX dimensions before the shared /personal registry."""
